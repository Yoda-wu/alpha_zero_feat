...
def run():
    n = 5
    width, height = 8, 8
    model_file = 'best_policy_8_8_5_new.model'  #model_file = 'best_policy_8_8_5.model'
    try:
...
#        mcts_player = MCTSPlayer(best_policy.policy_value_fn, c_puct=5, n_playout=400)  
        ...
        #best_policy = PolicyValueNetNumpy(width, height, policy_param)  #modified by haward 2018/03/09
